...
- Added MCP Integration Coach so students and judges can preview a credentials-safe Composio handoff to Google Docs, Google Sheets, Google Drive, Google Classroom, and Notion.
