...
Show Top Award Radar, UX and Accessibility Proof, Official AIYES Rules Snapshot, AIYES Submission Gate, and AIYES Demo Rehearsal: Ouija is submittable and competitive, but it does not pretend first place is guaranteed. Point to the official Gold/Silver/Bronze/Honorable Mention award bands, the Gold-level evidence target, July 14 verified deadline, 71-participant snapshot, eligibility, Track 1 artifacts, judging criteria, problem relevance, AI/model strategy, student-first UX, responsive/no-overflow proof, deck/video/source readiness, the 4:45 demo path, the pilot evidence quality gate, and the external Devpost/team/judging blockers.
