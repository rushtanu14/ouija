...
Show Top Award Radar, UX and Accessibility Proof, and AIYES Submission Gate: Ouija is submittable and competitive, but it does not pretend first place is guaranteed. Point to the official Gold/Silver/Bronze/Honorable Mention award bands, the Gold-level evidence target, problem relevance, AI/model strategy, student-first UX, responsive/no-overflow proof, deck/video/source readiness, the pilot evidence quality gate, and the external Devpost/team/judging blockers.
