...
`ffprobe` confirmed 1440x900 video, 24,090,761 bytes, duration 228.92 seconds, and SHA-256 `1c3221d19508b61f7ddb86631a1d481549f2058188a349ba92b7c2828eb0e8f0`. Local public package proof after sync is submission hub size `8956`, Devpost pack size `11562`, walkthrough size `24090761`, slide deck size `21302`, desktop screenshot size `4141522`, mobile screenshot size `2629786`, custom-triage screenshot size `4012572`, and warning-state screenshot size `4208588`.

Production deployment `dpl_CiAYrCC59JKSvNpicwDuKduUvG2g` is aliased to `https://ouija-olive.vercel.app`; hosted checks returned HTTP 200 for `/api/evaluate` with score `100`, `/api/mcp/status` with `server_dry_run`, 14 routes, and `gmail-teacher-review-draft`, `/api/runtime-proof`, `/submission/`, `/submission/devpost-pack.html`, `/submission/slide-deck.html` with quality-gate deck copy, and `/submission/assets/ouija-walkthrough.webm` with `content-length: 24090761`. Hosted desktop browser smoke confirmed the Pilot Evidence Quality Gate at `80/100`, Top Award Radar `quality gate 80/100`, no horizontal overflow, and zero console errors.
