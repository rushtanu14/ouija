...
describe("AIYES submission assets", () => {
  ...
  it("includes Devpost-ready copy and asset instructions", () => {
    ...
    expect(assets).toContain("23,141,674 bytes");
    expect(assets).toContain("339afb649cae9a5b6ac3a666434ef136e038e93c8f4123b5323b37ca9bb2c1cd");
    ...
    expect(hub).toContain("236.84 second walkthrough");
    expect(hub).toContain("339afb649cae9a5b6ac3a666434ef136e038e93c8f4123b5323b37ca9bb2c1cd");
